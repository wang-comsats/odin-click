...
odinagent::OdinAgent(10:0B:A9:F1:E0:60, RT rates, CHANNEL 4, DEFAULT_GW 172.16.250.1, DEBUGFS /home/fran/bisdn/click/debugfs)
TimedSource(2, "ping
...
FromHost(ap, HEADROOM 50)
  ...
  -> fh_arpr :: ARPResponder(127.0.0.1 98:d6:f7:67:6b:ee) // Resolve STA's ARP
...
odinagent[1]
  ...
  -> arp_resp::ARPResponder (127.0.0.1 00-1B-B3-67-6B-EE) // ARP fast path for STA
  -> [1]odinagent
