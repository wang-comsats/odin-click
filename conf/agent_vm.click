...
TimedSource(2, "ping
")->  odinsocket::Socket(UDP, 192.168.122.229, 2819, CLIENT true)
...
FromHost(ap, HEADROOM 50)
  ...
  -> fh_arpr :: ARPResponder(192.168.122.1 98:d6:f7:67:6b:ee) // Resolve STA's ARP
...
odinagent[1]
  ...
  -> arp_resp::ARPResponder (192.168.122.1 00:1B:B3:67:6B:EE) // ARP fast path for STA
  -> [1]odinagent
